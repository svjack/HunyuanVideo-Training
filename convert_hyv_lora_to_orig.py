    ...
    for key in diffusers_lora_sd.keys():
        ...
        if key.startswith("transformer_blocks"):
            ...
            if key.endswith("to_q.lora_A.weight"):
                ...
                qkv_A_key = key.replace("transformer_blocks", prefix + "double_blocks").replace("attn.to_q", "img_attn_qkv")
            ...
            # txt_attn
                ...
                qkv_A_key = key.replace("transformer_blocks", prefix + "double_blocks").replace("attn.add_q_proj", "txt_attn_qkv")
                converted_lora_sd[qkv_A_key] = to_qkv_A
